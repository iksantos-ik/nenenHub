...
INSERT INTO "new_Reserva" ("aprovado", "dataHoraFim", "dataHoraInicio", "id", "reprovado", "salaId", "titulo", "usuario") SELECT "aprovado", "dataHoraFim", "dataHoraInicio", "id", "reprovado", "salaId", "titulo", "usuario" FROM "Reserva";
DROP TABLE "Reserva";
